        ...
        child: Column(
          children: [
            ...
            const Text(
              'Smoked Salmon',
              style: TextStyle(
                  fontSize: 28, fontFamily: kfontPop, color: Colors.black),
            ),
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 50),
              child: Text(
                'This sushi recipe from All recipes is the simplest  to make ',
                style: TextStyle(
                    fontSize: 18, fontFamily: kfontPop, color: Colors.black),
              ),
            ),
            const SizedBox(
              height: 20,
            ...
            ElevatedButton(
              ...
              child: const Text(
                ' SHOP NOW ',
                style: TextStyle(fontFamily: kfontPop, fontSize: 18),
              ),
            )
          ],
        ));
