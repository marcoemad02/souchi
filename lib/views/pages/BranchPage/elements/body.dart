          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                ExpansionTile(title:TextWithDividerWidget(text: '   FAISAL BRANCHES'),children: [
                  BranchWidget(
                ...
                // Haram Branches     //  ID =2
               ExpansionTile(title: const TextWithDividerWidget(text: '   HARAM BRANCHES'),
                 children: [
                   BranchWidget(
                ...
                ExpansionTile(title: const TextWithDividerWidget(text: '   OCTOBER BRANCHES'),
                    children: [
                      BranchWidget(
                ...
                // Nasr City Branches
                ExpansionTile(title:  const TextWithDividerWidget(text: '   NASR CITY BRANCHES'),
                ...
                // Zayed City
                ExpansionTile(title:    const TextWithDividerWidget(text: '   ZAYED CITY BRANCHES'),
                ...
                // Giza
                ExpansionTile(title:  const TextWithDividerWidget(text: '   GIZA BRANCHES'),
           ...
           //Shoubra
                ExpansionTile(title: const TextWithDividerWidget(text: '   SHOUBRA BRANCHES'),children: [
                  BranchWidget(
