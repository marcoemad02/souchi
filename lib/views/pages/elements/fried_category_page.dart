...
class FriedCategoryPage extends StatelessWidget {
  const  FriedCategoryPage({super.key, required this.streamBranch, required this.branchName, required this.branchId, required this.streamBranchFried});
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Expanded(child: RawShopProductList(branchName: branchName,branchId: branchId,streamBranch: streamBranchFried,)),
